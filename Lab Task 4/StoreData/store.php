	    ...
	    <br>
		   <div> 
		      ...
		      <p> <h1 style="color: green">  X  <sub style="color:black">Company </sub> <h1> <p/>
		       ...
		       <a style="color:SlateBlu;" href="http://localhost/Webtech/LAB/Lab%20Task%204/PublicHome/PublicHome.php"> Home | </a> 
		       <a style="color:SlateBlu;" href="http://localhost/Webtech/LAB/Lab%20Task%204/Login/Login.php">  Login |  </a> 
		       <a style="color:SlateBlu;" href="http://localhost/Webtech/LAB/Lab%20Task%204/StoreData/store.php">  Registration </a> 
